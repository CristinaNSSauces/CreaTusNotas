...
<div class="container-form">
    <form name="form-nota" method="get" class="formulario">
        <fieldset>
            ...
            <br>
            <button type="button" name="enviar" @click="editar">Editar Nota</button>
            <br>
            <button type="button" name="cancelar" @click="$router.push('/')">Cancelar</button>
        </fieldset>
    </form>
</div>
</template>
        ...
        obtenerDatos: function(){
            ...
            // cuando se ha resuelto la promesa
                ...
                (response) => {
                    ...
                    this.fecha_vencimiento = response.data.data[0].fecha_vencimiento;
